...
import 'package:flutter_redux_seed/redux/middleware/navigation_middleware.dart';
...
DevToolsStore<AppState> initRedux() {
  return DevToolsStore<AppState>(appStateReducer,
      initialState: AppState.initialState(), middleware: [...persistStateMiddleware(), ...navigationMiddleware()]);
}
